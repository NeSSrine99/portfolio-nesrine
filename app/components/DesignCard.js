...
const DesignCard = ({
  ...
  return (
    <motion.div
      ...
      viewport={{ once: true }}
      className="min-w-[280px] max-w-[350px] h-[200px] mx-auto relative rounded-2xl overflow-hidden  bg-white"
    >
      <Swiper
      ...
      <motion.div
        ...
        className="absolute bottom-3 right-3 z-50 bg-Primary p-3 rounded-full shadow-md cursor-pointer"
      >
